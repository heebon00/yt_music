  ...
  return (
    <div className="pb-8">
      ...
      <button
        type="button"
        onClick={openPlayer}
        className="mx-5 flex w-[calc(100%-2.5rem)] items-center gap-4 rounded-card bg-elevated p-3 text-left
      ...
      <section className="pt-7">
        <h2 className="mb-2 px-5 text-[15px] font-semibold">최근 들은 목록</h2>
